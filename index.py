...
class Sell(QtWidgets.QFrame):
    def __init__(self):
        ...
        self.table_header = ['Product', 'Code', 'Categorie', 'Operation', 'Quantity', 'Person', 'Price', 'Paid', 'Total']
    ...
    def save_buy(self):#todo make all of this compatible with salles and buys operations
